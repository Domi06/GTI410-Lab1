...
public class FillTypeRadioButtonMediator implements ActionListener{
	/**
	 * Radio Button pour choisir le mode Boundary Fill
	 */
	private JRadioButton rbBoundaryFill;
	/**
	 * Radio Button pour choisir le mode Flood Fill
	 */
	private JRadioButton rbFloodFill;
	/**
	 * Groupe composŽ de rbBoundaryFill et de rbFloodFill 
	 */
