...
public class Pixel {
	...
	public Pixel(int c, int m, int y, int k, String mode) {
		if(mode == "cmyk")
		{
			int C = ( c/255 	* ( 1 - k/255 ) + k/255 );
			int M = ( m/255 	* ( 1 - k/255 ) + k/255 );
			int Y = ( y/255 	* ( 1 - k/255 ) + k/255 );
	 ...
	 */            
    public int getCyan() {
    	System.out.println("Blue "+this.getBlue() + " "+ ((valueARGB) & 0xff));
    	return (0); 
    }
